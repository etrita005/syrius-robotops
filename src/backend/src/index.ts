...
import {
  ...
  TransferAlgorithmConfigTask, MockTransferAlgorithmConfigTask,
  UpdateAlgorithmConfigTask, MockUpdateAlgorithmConfigTask,
  DeleteAlgorithmConfigTask, MockDeleteAlgorithmConfigTask,
...
async function main(): Promise<void> {
  ...
  registerTasks(resolverRegistry, config.runtime.mock, [
    ...
    { name: "TransferAlgorithmConfigTask", real: TransferAlgorithmConfigTask, mock: MockTransferAlgorithmConfigTask },
    { name: "UpdateAlgorithmConfigTask", real: UpdateAlgorithmConfigTask, mock: MockUpdateAlgorithmConfigTask },
    { name: "DeleteAlgorithmConfigTask", real: DeleteAlgorithmConfigTask, mock: MockDeleteAlgorithmConfigTask },
