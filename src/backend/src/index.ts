...
async function main(): Promise<void> {
  ...
  registerTasks(resolverRegistry, config.runtime.mock, [
    ...
    { name: "StopAppServiceTask", real: StopAppServiceTask, mock: MockStopAppServiceTask },
    { name: "InstallAppTask", real: InstallAppTask, mock: MockInstallAppTask },
    { name: "StartAppServiceTask", real: StartAppServiceTask, mock: MockStartAppServiceTask },
    { name: "DeleteAppTask", real: DeleteAppTask, mock: MockDeleteAppTask },
  ]);
